(function ($) {
    $(function () {
        ...
        _$auditLogFilterForm.find('input.date-range-picker').daterangepicker(
            ...
            function (start, end) {
                _selectedDateRangeAuditLog.startDate = start.format('YYYY-Mkt-DDT00:00:00Z');
                _selectedDateRangeAuditLog.endDate = end.format('YYYY-Mkt-DDT23:59:59.999Z');
        ...
        _$entityChangeFilterForm.find('input.date-range-picker').daterangepicker(
            ...
            function (start, end) {
                _selectedDateRangeEntityChange.startDate = start.format('YYYY-Mkt-DDT00:00:00Z');
                _selectedDateRangeEntityChange.endDate = end.format('YYYY-Mkt-DDT23:59:59.999Z');
        ...
        var auditLogDataTable = _$auditLogsTable.DataTable({
            ...
            searching: false,
            listAction: {
                ajaxFunction: _auditLogService.getPagedAuditLogs,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    rowAction: {
                        element: $("<div/>")
                            ...
                            .append($("<button/>")
                                .addClass("btn kt-btn kt-btn--hover-accent kt-btn--icon kt-btn--icon-only kt-btn--pill")
                ...
                },
                {
                    ...
                    render: function (executionTime) {
                        return moment(executionTime).format('YYYY-Mkt-DD HH:mm:ss');
                    }
                },
                {
                    targets: 4,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (changeTime) {
                        return moment(changeTime).format('YYYY-Mkt-DD HH:mm:ss');
                    }
                }
            ]
        });
        ...
        function showAuditLogDetails(auditLog) {
            ...
            $('#AuditLogDetailModal_ExecutionTime').html(moment(auditLog.executionTime).fromNow() + ' (' + moment(auditLog.executionTime).format('YYYY-Mkt-DD hh:mm:ss') + ')');
