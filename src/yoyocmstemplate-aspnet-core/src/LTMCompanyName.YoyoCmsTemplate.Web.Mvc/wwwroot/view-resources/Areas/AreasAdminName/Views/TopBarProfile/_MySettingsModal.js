    ...
    app.modals.MySettingsModal = function () {
        ...
        this.init = function (modalManager) {
            ...
            var smsVerificationModal = new app.ModalManager({
                viewUrl: abp.appPath + 'AreasAdminName/Profile/SmsVerificationModal',
                scriptUrl: abp.appPath + 'view-resources/Areas/AreasAdminName/Views/Profile/_SmsVerificationModal.js',
