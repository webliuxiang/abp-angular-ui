(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AreasAdminName/Languages/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AreasAdminName/Views/Languages/_CreateOrEditModal.js',
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                document.location.href = abp.appPath + "AreasAdminName/Languages/Texts?languageName=" + data.record.name;
                            }
                        }, {
                ...
                },
                {
                    ...
                    render: function (displayName, type, row, meta) {
                        var $span = $('<div/>').addClass("kt-demo-icon")
                            .append($('<div/>')).addClass('kt-demo-icon__preview')
                        ...
                        if (meta.settings.rawServerResponse.defaultLanguageName === row.name) {
                            $span.addClass("font-weight-bold").append(" (" + app.localize("Default") + ")");
                        }
                ...
                },
                {
                    ...
                    render: function (isDisabled) {
                        ...
                        var $span = $("<span/>").addClass("label");
                        if (isEnabled) {
                            $span.addClass("kt-badge  kt-badge--success kt-badge--inline kt-badge--pill").text(app.localize('Yes'));
                        } else {
                            $span.addClass("kt-badge  kt-badge--metal kt-badge--inline kt-badge--pill").text(app.localize('No'));
                        }
