(function () {
    $(function () {
        ...
        var _permissions = {
            ...
            manageMembers: abp.auth.hasPermission('Pages.Administration.OrganizationUnits.ManageUsers'),
            manageRoles: abp.auth.hasPermission('Pages.Administration.OrganizationUnits.ManageRoles')
        };

        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AreasAdminName/OrganizationUnits/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AreasAdminName/Views/OrganizationUnits/_CreateModal.js',
            modalClass: 'CreateOrganizationUnitModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AreasAdminName/OrganizationUnits/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AreasAdminName/Views/OrganizationUnits/_EditModal.js',
            modalClass: 'EditOrganizationUnitModal'
        });

        var _addUserModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AreasAdminName/OrganizationUnits/AddMemberModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AreasAdminName/Views/OrganizationUnits/_AddMemberModal.js',
        ...
        var _addRoleModal = new app.ModalManager({
            viewUrl: abp.appPath + 'AreasAdminName/OrganizationUnits/AddRoleModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/AreasAdminName/Views/OrganizationUnits/_AddRoleModal.js',
     ...
     //   var _entityTypeHistoryModal = app.modals.EntityTypeHistoryModal.create();
        ...
        var organizationTree = {
            ...
            getTreeDataFromServer: function (callback) {
                _organizationUnitService.getAllOrganizationUnitList({}).done(function (result) {
        ...
        var members = {
            ...
            add: function (users) {
                ...
                var userIds = _.map(users, "value");
                _organizationUnitService.addUsers({
            ...
            init: function () {
                this.dataTable = members.$table.find(".organization-members-table").DataTable({
                    ...
                    listAction: {
                        ajaxFunction: _organizationUnitService.getPagedOrganizationUnitUsers,
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            rowAction: {
                                ...
                                defaultContent: '',
                                element: $("<button/>")
                                    .addClass("btn btn-outline-danger btn-elevate btn-icon")
        ...
        var roles = {
            ...
            init: function () {
                this.dataTable = roles.$table.find(".organization-roles-table").DataTable({
                    ...
                    deferLoading: 0, //prevents table for ajax request on initialize
                    listAction: {
                        ajaxFunction: _organizationUnitService.getPagedOrganizationUnitRoles,
                        inputFilter: function () {
                            return { id: organizationTree.selectedOu.id };
                        }
                    },
