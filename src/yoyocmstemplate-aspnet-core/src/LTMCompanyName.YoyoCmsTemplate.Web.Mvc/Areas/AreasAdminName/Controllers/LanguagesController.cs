...
using LTMCompanyName.YoyoCmsTemplate.Web.Mvc.Areas.AreasAdminName.ViewModels.Languages;
...
namespace LTMCompanyName.YoyoCmsTemplate.Web.Mvc.Areas.AreasAdminName.Controllers
{
    ...
    [AbpMvcAuthorize(YoyoSoftPermissionNames.Pages_Administration_Languages)]
    public class LanguagesController : YoyoCmsTemplateControllerBase
    {
        ...
        [AbpMvcAuthorize(YoyoSoftPermissionNames.Pages_Administration_Languages_Create, YoyoSoftPermissionNames.Pages_Administration_Languages_Edit)]
        ...
        [AbpMvcAuthorize(YoyoSoftPermissionNames.Pages_Administration_Languages_ChangeTexts)]
