...
using LTMCompanyName.YoyoCmsTemplate.Web.Mvc.Areas.AreasAdminName.ViewModels.Tenants;
using Microsoft.AspNetCore.Mvc;

namespace LTMCompanyName.YoyoCmsTemplate.Web.Mvc.Areas.AreasAdminName.Controllers
{
    [Area(AppConsts.AreasAdminName)]
    [AbpMvcAuthorize(YoyoSoftPermissionNames.Pages_Tenants)]
    public class TenantsController : YoyoCmsTemplateControllerBase
    {
        ...
        [AbpMvcAuthorize(YoyoSoftPermissionNames.Pages_Tenants_Create)]
        ...
        [AbpMvcAuthorize(YoyoSoftPermissionNames.Pages_Tenants_Edit)]
        public async Task<PartialViewResult> EditModal(int id)
        {
            var tenantEditDto = await _tenantAppService.GetForEdit(new EntityDto(id));
        ...
        [AbpMvcAuthorize(YoyoSoftPermissionNames.Pages_Tenants_ChangeFeatures)]
