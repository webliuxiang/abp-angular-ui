...
namespace LTMCompanyName.YoyoCmsTemplate.Web.Public.Extensions
{
    /// <summary>
    /// Url 地址辅助操作类
    /// </summary>
    public static class UrlHelperExtensions
    {
        ...
        public static string ToMvcMenuUrl(this string url)
        {
            ...
            return index.Any(u => u.Contains(url, StringComparison.OrdinalIgnoreCase)) ? "~/Admin/Index" : url.Replace("/Pages/", "~/");
        }
    }
}
