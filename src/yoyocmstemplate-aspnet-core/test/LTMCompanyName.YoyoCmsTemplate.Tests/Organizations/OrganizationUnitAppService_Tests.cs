...
using LTMCompanyName.YoyoCmsTemplate.Organizations;
using LTMCompanyName.YoyoCmsTemplate.Organizations.Dtos;
using Shouldly;
using Xunit;

namespace LTMCompanyName.YoyoCmsTemplate.Tests.Organizations
{
    // ReSharper disable once InconsistentNaming
    public class OrganizationUnitAppService_Tests : YoyoCmsTemplateTestBase
    {
        ...
        [Fact]
        public async Task Test_GetAllOrganizationUnits()
        {
            //Act
            var output = await _organizationUnitAppService.GetAllOrganizationUnitList();
        ...
        public async Task Test_GetOrganizationUnitUsers()
        {
            ...
            //Act
            await _organizationUnitAppService.GetPagedOrganizationUnitUsers(
        ...
        public async Task Test_CreateOrganizationUnit()
        {
            ...
            //Act
            await _organizationUnitAppService.Create(new CreateOrganizationUnitInput
            {
                ParentId = ou11.Id,
        ...
        public async Task Test_UpdateOrganizationUnit()
        {
            ...
            //Act
            await _organizationUnitAppService.Update(new UpdateOrganizationUnitInput
            {
                Id = ou11.Id,
        ...
        public async Task Test_MoveOrganizationUnit()
        {
            ...
            //Act
            var output = await _organizationUnitAppService.Move(new MoveOrganizationUnitInput
            {
                Id = ou11.Id,
                NewParentId = ou12.Id
            });
        ...
        public async Task Test_DeleteOrganizationUnit()
        {
            ...
            //Act
            await _organizationUnitAppService.Delete(new EntityDto<long>(ou11.Id));
        ...
        public async Task Test_AddUsersToOrganizationUnit()
        {
            ...
            //Act
            await _organizationUnitAppService.AddUsers(
                new UsersToOrganizationUnitInput
                {
                    UserIds = new List<long>() { admin.Id },
            ...
            var output = await _organizationUnitAppService.GetPagedOrganizationUnitUsers(new GetOrganizationUnitUsersInput { Id = ou12.Id });
        ...
        public async Task Test_RemoveFromOrganizationUnit()
        {
            ...
            //Act
            await _organizationUnitAppService.RemoveUser(
