...
namespace LTMCompanyName.YoyoCmsTemplate.Tests.Users
{
    ...
    public class UserAppService_PermissionEdit_Tests : UserAppServiceTestBase
    {
        ...
        public async Task Should_Update_User_Permissions()
        {
            ...
            //Act
            await UserAppService.UpdatePermissions(
            ...
            UsingDbContext(
                context => context.UserPermissions.Add(
                    new UserPermissionSetting
                    {
                        ...
                        UserId = admin.Id,
                        Name = YoyoSoftPermissionNames.Pages_Administration_Roles,
                        IsGranted = false
                    }));

            //Act
            await UserAppService.ResetSpecificPermissions(new EntityDto<long>(admin.Id));
