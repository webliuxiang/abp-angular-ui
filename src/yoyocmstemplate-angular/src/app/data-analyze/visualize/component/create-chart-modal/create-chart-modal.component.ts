...
@Component({
  selector: 'app-create-chart-modal',
  templateUrl: './create-chart-modal.component.html',
  styles: [],
})
export class CreateChartComponent extends PagedListingComponentBase<YSLogDataSetObjectListDto> implements OnInit {
