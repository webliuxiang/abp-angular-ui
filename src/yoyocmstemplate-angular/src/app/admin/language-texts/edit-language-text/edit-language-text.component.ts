...
export class EditLanguageTextComponent extends ModalComponentBase implements OnInit {
  @Input()
  ...
  private findLanguage(name: string): abp.localization.ILanguageInfo {
    return abp.localization.languages.find((item, index, array) => item.name === name);
  }
}
