...
```ts
{//	文章的菜单按钮
text:'Post',i18n:'Post',acl:'Pages.Post',icon:'iconfont icon-dashboard',link:'/app/main/posts',sort:'99'},

```

请注意：以上link的值 '/app/main/posts') 中的 main在是指模块名称为main.module.ts，所以在添加菜单时请注意。
...
new MenuItem('Post', 'Pages.Post', 'iconfont icon-dashboard', '/app/main/posts')
