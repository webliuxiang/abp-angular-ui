            ...
            <div class="table--container">
                ...
                <a-row :gutter="8" class="opeattion-container">
                    ...
                    <a-col :span="6" :offset="2">
                        <a @click="addRole()" v-if="isGranted('Pages.Administration.OrganizationUnits.ManageRoles')">
                            <a-icon type="plus" /> {{ l('CreateNewRole') }} </a>
                        <a-divider v-if="isGranted('Pages.Administration.OrganizationUnits.ManageRoles')" type="vertical"></a-divider>
                        <a @click="batchDelete()" v-if="isGranted('Pages.Administration.OrganizationUnits.ManageRoles')">
                            <a-icon type="delete" />{{ l('BatchDelete') }} </a>
                        <a-divider type="vertical" v-if="isGranted('Pages.Administration.OrganizationUnits.ManageRoles')"></a-divider>
...
export default {
        ...
        return {
            ...
            columns: [
                ...
                },
                {
                    ...
                    sorter: true,
                    align: "center",
                    scopedSlots: { customRender: "addedTimeStr" }
                },
                {
    ...
    methods: {
         ...
         */
        addRole() {
            ModalHelper.create(AddRoleComponent, {
